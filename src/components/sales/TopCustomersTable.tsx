...
type SortField = 'customerName' | 'totalSpent' | 'orderCount' | 'avgOrderValue' | 'daysSinceLastOrder';
      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {sortedData.map((item, index) => (
            <tr key={item.customerCode} className="border-b border-border/50 hover:bg-muted/50">
